...
- **GitHub Security Advisories** — [open a private report](https://github.com/semitexa/semitexa-tenancy/security/advisories/new).
...
- **Email** — `support@semitexa.com`. Put "security" and the package name
  (`semitexa/tenancy`) in the subject.
...
In scope: anything in `semitexa/tenancy` that lets a request, a job or a message do
